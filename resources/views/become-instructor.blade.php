...
<div style="font-weight: bold; font-size:2em" class="center-align mar-top-25">
  Terms and Conditions
</div>

<pre class="container mar-top-25 mar-bot-25">
  General Site Usage
...
<div class="container center-align mar-bot-25">
  <form method="POST" action="{{ url('/' )}}/become-instructor">
    {{ csrf_field() }}
    <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">

    <button type="submit" class="btn">ยอมรับเงื่อนไข</button>
  </form>
</div>
